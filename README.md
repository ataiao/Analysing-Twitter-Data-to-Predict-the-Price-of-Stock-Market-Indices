...
For the final part of the project, I conducted a ‘Backtest’ and devised a trading strategy that predicted the direction of stock Returns for the FTSE index. I derived cumulative P&L scores, which revealed that from an economic perspective it is a good option.
...
The Cumulative P&L for Score Replies(0.825) and Score Favorites(0.6) are much higher in comparison to other variables. The two variables are predictive anf generate a positive P&L.
